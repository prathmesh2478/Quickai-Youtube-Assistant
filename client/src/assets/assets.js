...
import { SquarePen,Youtube, Hash, Image, Eraser, Scissors, FileText } from 'lucide-react'
...
export const AiToolsData = [
    {
        title: 'YouTube AI Tutor',
        description: 'Transform any YouTube video into detailed study notes, summaries, and interactive chat sessions instantly.',
        Icon: Youtube,
        bg: { from: '#EF4444', to: '#B91C1C' }, // YouTube Red gradient
        path: '/ai/study-sessions'
    },
    {
